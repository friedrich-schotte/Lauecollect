...
Friedrich Schotte, NIH, 5 Feb 2008 - Mar 16, 2018
Valentyn Stadnytskyi, NIH, Oct 26 2018

6.3.6 - version has name for the settings file
and camera name to get camera properties
"""
...
class CameraViewer(wx.Frame):
    ...
    __version__ = "6.3.5" # wx 4.0 compatibility: BitmapFromImage
...
if __name__ == "__main__": # for testing
    ...
    viewer = CameraViewer(name="MicroscopeCamera")
    wx.app.MainLoop()
