...
'DT = 0.9999943*DT 'correction to match APS frequency
 DT=1.0000034*(1.0055228571428572)*DT'FPGA internal oscillator for Pico23
...
PVT 2: Zi+DZ, 0,4: PumpA_pos, 0,6: msShut_close2, 0 @( Ti+(232)*DT) |DOUT 0:1, 0,15 
PVT 2: Zi+DZ, 0,4: PumpA_pos, 0,6: msShut_open, 0 @( Ti+240*DT) |DOUT 0:1, 5,15 
PVT 2: Zi+DZ, 0,4: PumpA_pos, 0,6: msShut_close1, 0 @( Ti+(248)*DT) |DOUT 0:1, 0,15 
T_0=T_0+480*DT
NEXT i
Ti=T_0
...
PVT 2: Z_end, 0,4: PumpA_pos, 0,6: msShut_close1, 0 @( Ti+20*DT) |DOUT 0:1, 0,15 
