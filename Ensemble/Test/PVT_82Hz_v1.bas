...
'User input (Z_0, PumpA_step)
 Z_0=-11.734999999999999'slot 0 position -> -11.455 on 12/15/14 when in use
...
PVT 2:(Zi-DZ/2),0,4: PumpA_pos, 0 @Ti+(30*DT) |DOUT 0:1, 0,1 
ELSE
PVT 2: Zi, 0,4: PumpA_pos, 0 @( Ti-DT) |DOUT 0:1, 1,1 
