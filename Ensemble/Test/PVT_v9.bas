...
'User input (Z_1, PumpA_step)
 Z_41=12.720000000000001'slot 41 position w/ cooling water set to 5 Celsius.
...
Ti=T_0+6*i*DT
IF i=Nslots THEN
PVT 2: Zi, 0,4: PumpA_pos, 0 @( Ti-3*DT) |DOUT 0:1, 1,15 
PVT 2: Zi, 0,4: PumpA_pos, 0 @Ti |DOUT 0:1, 7,15 
PVT 2: Z_end, 0,4: PumpA_pos, 0 @( Ti+3*DT) |DOUT 0:1, 0,15 
PVT 2: Z_end, 0,4: PumpA_pos, 0 @( T_0+(270)*DT) |DOUT 0:1, 0,15 
PumpA_pos=PumpA_pos+PumpA_step
PVT 2: Z_start, 0,4: PumpA_pos, 0 @( T_0+(285)*DT) |DOUT 0:1, 0,15 
ELSE
PVT 2: Zi, 0,4: PumpA_pos, 0 @( Ti-3*DT) |DOUT 0:1, 1,15 
PVT 2: Zi, 0,4: PumpA_pos, 0 @Ti |DOUT 0:1, 7,15 
END IF
...
ELSE
PVT 2: Z_1, 0,4: PumpA_pos, 0 @( T_0+DT) |DOUT 0:1, 0,15 
PVT 2: Z_1, 0,4: PumpA_pos, 0 @( T_0+(270)*DT) |DOUT 0:1, 0,15 
PVT 2: Z_start, 0,4: PumpA_pos, 0 @( T_0+285*DT) |DOUT 0:1, 0,15 
