...
'Millisecond shutter open parameters (0:NIH, 1:APS, 2:LCLS)
 msShut_open_array(0)=56
msShut_open_array(1)=9.6999999999999993
msShut_open_array(2)=56

'Millisecond shutter step size (0:NIH, 1:APS, 2:LCLS; open to close in degrees)
 msShut_step_array(0)=7
msShut_step_array(1)=10
msShut_step_array(2)=7
...
IF shut_mode=0 THEN
Ti=Ti+12*DT
PVT 6: msShut_pos0, 0 @Ti 
msShut_pos=msShut_pos0
ELSE
Ti=Ti+6*DT
PVT 6: msShut_pos1, 0 @Ti 
