...
try:
    import numpy as _Numeric # was: numpy.oldnumeric
except:
    try:
...
class PlotCanvas(wx.Panel):
    ...
    def __init__(self, parent, id=wx.ID_ANY, pos=wx.DefaultPosition,
        ...
        try: self.HandCursor = wx.CursorFromImage(getHandImage())
        except: self.HandCursor = wx.StockCursor(wx.CURSOR_HAND)
        try: self.GrabHandCursor = wx.CursorFromImage(getGrabHandImage())
        except: self.GrabHandCursor = wx.StockCursor(wx.CURSOR_HAND)
        try: self.MagCursor = wx.CursorFromImage(getMagPlusImage())
        except: self.MagCursor = wx.StockCursor(wx.CURSOR_MAGNIFIER)
