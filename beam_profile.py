...
Date last modified: 2020-03-06
Revision comment: Fixed: Python 3 compatibility
"""
__version__ = "1.0.2" 
...
def xy_projections(image,center,d):
    ...
    xprofile = list(zip(xscale,xproj))
    yprofile = list(zip(yscale,yproj))

    return xprofile,yprofile

def overloaded_pixels(image,center,d):
...
def x_projection(image,center,d):
    """Calculate a horizonal and vertical projections of a region of interest
    of the image.
    image: 2D numpy array, must have "pixelsize" attribute
    center (cx,cy): center in mm
...
def y_projection(image,center,d):
    """Calculate a horizonal and vertical projections of a region of interest
    of the image.
    image: 2D numpy array, must have "pixelsize" attribute
    center (cx,cy): center in mm
