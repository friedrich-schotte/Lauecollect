...
class Camera_image_analyser(object):
    ...
    def __init__(self, name = 'camera_image_analyser', camera_name = 'MicroscopeCamera'):
        ...
        if os.path.exists(os.path.dirname(self.logFolder+ 'Images/') ):
            pass
        else:
            os.makedirs(os.path.dirname(self.logFolder+ 'Images/'))
        try:
        ...
        if os.path.isfile(self.logfile):
            ...
            f.write('time,frame_count, temperature, mean, mean_R,mean_G,mean_B,stdev,stdev_R,stdev_B,stdev_G\r\n')
            f.close()
...
optical_freeze_detector = Camera_image_analyser(name = 'optical_freeze_analyser', camera_name = 'MicroscopeCamera') #for optical freeze detector
laue_image_analyser = Camera_image_analyser(name = 'LAUE_image_analyser', camera_name = 'MicroscopeCamera') #for LAUE crystalography
camera_image_analyser = Camera_image_analyser() #for testing
