...
Date last modified: 2019-03-08
"""
__version__ = "3.7.1" # initialize globals and locals
...
##class Bar(metaclass=ClassPropertyMetaClass): # Python 3+
    ...
    @property
    def current_positions(self): return self.CurrentPositions(self)
    ...
    class CurrentPositions(object):
        ...
        def __getitem__(self,i):
            ...
            else: value = self.configuration.current_position(i)
            return value
        def __setitem__(self,i,value):
           self.configuration.set_current_position(i,value)
        def __len__(self): return len(self.configuration.motor_names)
        def __iter__(self):
            for i in range(0,len(self)):
                if i < len(self): yield self[i]

    def current_position(self,i):
    ...
    class CommandPositions(object):
        ...
        def __getitem__(self,i):
            ...
            return value
        def __setitem__(self,i,value):
            return self.configuration.set_current_position(i,value)
        def __len__(self): return len(self.configuration.motor_names)
        def __iter__(self):
            for i in range(0,len(self)):
                if i < len(self): yield self[i]
    ...
    @property
    def descriptions(self): return self.Values(self,"description","")
    ...
    @property
    def updated(self): return self.Values(self,"updated","")
