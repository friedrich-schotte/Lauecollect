...
Revision comment: Renamed: configuration_tables_client
"""
__version__ = "1.1"
...
@cached_function()
def configuration_tables_client(domain_name):
    return Configuration_Tables_Client(domain_name)


class Configuration_Tables_Client(object):
    ...
    def configuration(self, name):
        ...
        return configuration_client(self.domain_name + "." + name)
...
if __name__ == '__main__':
    ...
    self = configuration_tables_client(domain_name)
