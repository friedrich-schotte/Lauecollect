...
Contiunous readout at a fixed rate for optimium stability
Friedrich Schotte
Date created: 2016-06-17
Date last modified: 2019-03-17
"""
__version__ = "1.9.1" # Windows compatibility: import error for "link"
...
if __name__ == "__main__": # for debugging
    ...
    dir = "/net/mx340hs/data/anfinrud_1901/Test/Test-1/xray_images"
    ##dir = "/Mirror/femto-data/C/Data/2017.08/Test/WAXS/Test-1"
    N = 1
    filenames = [dir+"/Test_%03d.mccd" % (i+1) for i in range(0,N)]
    filename = filenames[0]
    from CA import camonitor,caget,caput
    print('self.trigger_monitoring = True')
    print('self.saving_images = True')
    print('self.acquire_images(range(1,N+1),filenames)')
    print('self.cancel_acquisition()')
