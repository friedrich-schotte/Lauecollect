Calibration.CustomView = ['X-ray Scope Trigger', 'Ps Laser Osc. Delay', 'Ps Laser Trigger', 'Ns Laser Q-Switch Trigger', 'Ns Laser Flash Lamp Trigger', 'Heatload Chopper Phase', 'Heatload Chop. Act. Phase', 'High-Speed Chopper Phase', 'X-ray Shutter Delay', 'X-ray Detector Pulse Length']
...
Calibration.ch17.step = 1.4207209306290384e-09