...
# Friedrich Schotte, NIH 4 Oct 2008 - 7 Dec 2009
...
from CA import caput,caget,camonitor
...
if __name__ == "__main__": # for testing - remove when done.
    port = Serial("14IDB:serial13")
    ##print repr(port.query("I",count=3)) # expecting "I\xca\x00"
    ##print repr(port.query("A",count=3)) # expecting "A\x18\x01"
    ##print repr(port.query("H",count=2)) # expecting "H\x00"
