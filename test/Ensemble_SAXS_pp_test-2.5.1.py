"""Author: Friedrich Schotte, Oct 21, 2015 - May 18, 2018
"""
...
def acquisition_start(): Ensemble_SAXS.acquisition_start()

def acquisition_setup():
    Ensemble_SAXS.acquire(delays,laser_ons,
        passes=passes,image_numbers=image_numbers)

def acquisition_cancel(): Ensemble_SAXS.acquisition_cancel()
...
print("acquisition_setup()")
print("acquisition_start()")
print("acquisition_cancel()")
##print("forever()")
