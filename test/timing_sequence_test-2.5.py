"""Friedrich Schotte, 23 Jul 2015 - 24 Sep 2015"""
__version__ = "2.4"
if __name__ == "__main__":
    ...
    nrepeat = 10 # pulses per image
    waitt_delay = rint(0.1/dt)*dt
    ...
    variables += [timing_system.xosct_on]; value_lists += [always]
    variables += [timing_system.losct_on]; value_lists += [always]
    variables += [timing_system.ms_on];    value_lists += [always]
