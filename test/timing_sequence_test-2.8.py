...
def set_sequence(variables,value_lists):
    """"""
    data,names = sequencer_packets(variables,value_lists)
...
def sequencer_packets(variables,value_lists):
    """return value, lsit of binary data packets and list of names"""
...
if __name__ == "__main__":
    ...
    print 'data,names = sequencer_packets(variables,value_lists)'
