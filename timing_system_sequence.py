...
Revision comment: Cleanup: timing_system_sequencer
"""
__version__ = "1.1.1"
...
class Sequence(object):
    def __init__(self, timing_system_name, delay=None, **kwargs):
    ...
    def get_register_specs(self):
        """Register objects and count arrays as tuple"""
        register_specs = self.composer.register_specs(self)
        return register_specs

    register_specs = property(get_register_specs)
    ...
    def id(self):
        """Binary data and descriptive string as tuple"""
        from timing_system_sequencer import get_hash
    ...
    def packet_representation(self):
        ...
        from timing_system_sequencer import packet_representation
